#Framework and depnedencies
-This is bootstrapped via Create React App
-uses npm for dependecy mangement, run npm install to install dependencies and npm start to run on local
-The project uses Redux for state mangement and redux thunk for managing asyncronous actions
-It does not use CSS preprocessor because the small size of css code made it superflous

#Patterns
-React code is organised using containers/component paradigm to enforce separation of concerns
-Stateless functions are use when possible 
-ES6 functionalities like find, assign, map and spread operator are used when needed
-Mobile first approach is applied to media query design
